    ...
    internal sealed class AnnualReturnsReportElement : ChartReportElement
    {
        ...
        public override string Render()
        {
            ...
            using (Py.GIL())
            {
                ...
                var backtestAnnualReturns = backtestSeries.ResampleEquivalence(date => new DateTime(date.Year, 1, 1), agg => agg.TotalReturns() * 100);
                ...
                //
                // df.pct_change().resample('AS').sum().mul(100)
                var liveAnnualReturns = liveSeries.ResampleEquivalence(date => new DateTime(date.Year, 1, 1), agg => agg.TotalReturns() * 100);
