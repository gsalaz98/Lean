...
namespace QuantConnect.Report.ReportElements
{
    internal sealed class LeverageUtilizationReportElement : ChartReportElement
    {
        ...
        public override string Render()
        {
            ...
            var backtestSeries = new Series<DateTime, double>(backtestPoints.Keys, backtestPoints.Values).LeverageUtilization(_backtest.Orders.Values.ToList()).DropMissing();
            var liveSeries = new Series<DateTime, double>(livePoints.Keys, livePoints.Values).LeverageUtilization(liveOrders).DropMissing();

            Logging.Log.Trace(liveSeries.ToString());
