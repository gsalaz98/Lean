...
if [[ " ${GENERATOR_CLI_ARGS[@]} " =~ " -h " ]]; then
    ...
    echo "  -b: Downloads and installs mono, Lean (nuget restore + build)"
...
function build_and_install {
    ...
    sudo apt-get update
    sudo apt-get install -y python3.6 mono-complete nuget
    
    install_ironpython
    
    nuget restore QuantConnect.Lean.sln
    msbuild /m /p:Configuration=Release /p:VbcToolExe=vbnc.exe QuantConnect.Lean.sln
