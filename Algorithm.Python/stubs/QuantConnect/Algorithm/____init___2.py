...
class QCAlgorithm(System.MarshalByRefObject, QuantConnect.Interfaces.IAlgorithm, QuantConnect.Interfaces.IAccountCurrencyProvider, QuantConnect.Interfaces.ISecurityInitializerProvider):
    """
