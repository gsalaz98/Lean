...
class ConcurrentSet(System.object, System.Collections.Generic.ICollection[T], System.Collections.Generic.IEnumerable[T], System.Collections.IEnumerable, System.Collections.Generic.ISet[T]):
    """ ConcurrentSet[T]() """
    def Add(self, item: QuantConnect.Util.T) -> None:
        pass
...
class FixedSizeQueue(System.Collections.Generic.Queue[T], System.Collections.Generic.IReadOnlyCollection[T], System.Collections.ICollection, System.Collections.Generic.IEnumerable[T], System.Collections.IEnumerable):
...
class FuncTextWriter(System.IO.TextWriter, System.IDisposable, System.IAsyncDisposable):
    """
