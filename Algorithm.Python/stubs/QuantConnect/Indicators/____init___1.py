...
class ArmsIndex(QuantConnect.Indicators.TradeBarIndicator, System.IComparable, System.IComparable[IIndicator[TradeBar]], QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, QuantConnect.Indicators.IIndicator[TradeBar], QuantConnect.Indicators.IIndicator):
    """
...
class ArnaudLegouxMovingAverage(QuantConnect.Indicators.WindowIndicator[IndicatorDataPoint], System.IComparable, System.IComparable[IIndicator[IndicatorDataPoint]], QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, QuantConnect.Indicators.IIndicator[IndicatorDataPoint], QuantConnect.Indicators.IIndicator):
    """
...
class BarIndicator(QuantConnect.Indicators.IndicatorBase[IBaseDataBar], System.IComparable, System.IComparable[IIndicator[IBaseDataBar]], QuantConnect.Indicators.IIndicator[IBaseDataBar], QuantConnect.Indicators.IIndicator):
    """
...
class AroonOscillator(QuantConnect.Indicators.BarIndicator, System.IComparable, System.IComparable[IIndicator[IBaseDataBar]], QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, QuantConnect.Indicators.IIndicator[IBaseDataBar], QuantConnect.Indicators.IIndicator):
    """
...
class AverageDirectionalIndex(QuantConnect.Indicators.BarIndicator, System.IComparable, System.IComparable[IIndicator[IBaseDataBar]], QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, QuantConnect.Indicators.IIndicator[IBaseDataBar], QuantConnect.Indicators.IIndicator):
    """
...
class AverageDirectionalMovementIndexRating(QuantConnect.Indicators.BarIndicator, System.IComparable, System.IComparable[IIndicator[IBaseDataBar]], QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, QuantConnect.Indicators.IIndicator[IBaseDataBar], QuantConnect.Indicators.IIndicator):
    """
...
class AverageTrueRange(QuantConnect.Indicators.BarIndicator, System.IComparable, System.IComparable[IIndicator[IBaseDataBar]], QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, QuantConnect.Indicators.IIndicator[IBaseDataBar], QuantConnect.Indicators.IIndicator):
    """
...
class BalanceOfPower(QuantConnect.Indicators.BarIndicator, System.IComparable, System.IComparable[IIndicator[IBaseDataBar]], QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, QuantConnect.Indicators.IIndicator[IBaseDataBar], QuantConnect.Indicators.IIndicator):
    """
...
class BollingerBands(QuantConnect.Indicators.Indicator, System.IComparable, System.IComparable[IIndicator[IndicatorDataPoint]], QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, QuantConnect.Indicators.IIndicator[IndicatorDataPoint], QuantConnect.Indicators.IIndicator):
    """
