...
class MovingAverageType(System.Enum, System.IComparable, System.IConvertible, System.IFormattable):
    """
...
class NormalizedAverageTrueRange(QuantConnect.Indicators.BarIndicator, System.IComparable, System.IComparable[IIndicator[IBaseDataBar]], QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, QuantConnect.Indicators.IIndicator[IBaseDataBar], QuantConnect.Indicators.IIndicator):
    """
...
class OnBalanceVolume(QuantConnect.Indicators.TradeBarIndicator, System.IComparable, System.IComparable[IIndicator[TradeBar]], QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, QuantConnect.Indicators.IIndicator[TradeBar], QuantConnect.Indicators.IIndicator):
    """
...
class ParabolicStopAndReverse(QuantConnect.Indicators.BarIndicator, System.IComparable, System.IComparable[IIndicator[IBaseDataBar]], QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, QuantConnect.Indicators.IIndicator[IBaseDataBar], QuantConnect.Indicators.IIndicator):
    """
...
class PercentagePriceOscillator(QuantConnect.Indicators.AbsolutePriceOscillator, System.IComparable, System.IComparable[IIndicator[IndicatorDataPoint]], QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, QuantConnect.Indicators.IIndicator[IndicatorDataPoint], QuantConnect.Indicators.IIndicator):
    """
...
class PythonIndicator(QuantConnect.Indicators.IndicatorBase[IBaseData], System.IComparable, System.IComparable[IIndicator[IBaseData]], QuantConnect.Indicators.IIndicator[IBaseData], QuantConnect.Indicators.IIndicator):
    """
...
class RateOfChangeRatio(QuantConnect.Indicators.RateOfChange, System.IComparable, System.IComparable[IIndicator[IndicatorDataPoint]], QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, QuantConnect.Indicators.IIndicator[IndicatorDataPoint], QuantConnect.Indicators.IIndicator):
    """
...
class RegressionChannel(QuantConnect.Indicators.Indicator, System.IComparable, System.IComparable[IIndicator[IndicatorDataPoint]], QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, QuantConnect.Indicators.IIndicator[IndicatorDataPoint], QuantConnect.Indicators.IIndicator):
    """
...
class RelativeStrengthIndex(QuantConnect.Indicators.Indicator, System.IComparable, System.IComparable[IIndicator[IndicatorDataPoint]], QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, QuantConnect.Indicators.IIndicator[IndicatorDataPoint], QuantConnect.Indicators.IIndicator):
    """
