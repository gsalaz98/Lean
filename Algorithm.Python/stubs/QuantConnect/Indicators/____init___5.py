...
class IndicatorStatus(System.Enum, System.IComparable, System.IConvertible, System.IFormattable):
    """
...
class IntradayVwap(QuantConnect.Indicators.IndicatorBase[BaseData], System.IComparable, System.IComparable[IIndicator[BaseData]], QuantConnect.Indicators.IIndicator[BaseData], QuantConnect.Indicators.IIndicator):
    """
...
class KaufmanAdaptiveMovingAverage(QuantConnect.Indicators.WindowIndicator[IndicatorDataPoint], System.IComparable, System.IComparable[IIndicator[IndicatorDataPoint]], QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, QuantConnect.Indicators.IIndicator[IndicatorDataPoint], QuantConnect.Indicators.IIndicator):
    """
...
class KeltnerChannels(QuantConnect.Indicators.BarIndicator, System.IComparable, System.IComparable[IIndicator[IBaseDataBar]], QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, QuantConnect.Indicators.IIndicator[IBaseDataBar], QuantConnect.Indicators.IIndicator):
    """
...
class LeastSquaresMovingAverage(QuantConnect.Indicators.WindowIndicator[IndicatorDataPoint], System.IComparable, System.IComparable[IIndicator[IndicatorDataPoint]], QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, QuantConnect.Indicators.IIndicator[IndicatorDataPoint], QuantConnect.Indicators.IIndicator):
    """
...
class LogReturn(QuantConnect.Indicators.WindowIndicator[IndicatorDataPoint], System.IComparable, System.IComparable[IIndicator[IndicatorDataPoint]], QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, QuantConnect.Indicators.IIndicator[IndicatorDataPoint], QuantConnect.Indicators.IIndicator):
    """
...
class MassIndex(QuantConnect.Indicators.TradeBarIndicator, System.IComparable, System.IComparable[IIndicator[TradeBar]], QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, QuantConnect.Indicators.IIndicator[TradeBar], QuantConnect.Indicators.IIndicator):
    """
