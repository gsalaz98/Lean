...
class ChandeMomentumOscillator(QuantConnect.Indicators.WindowIndicator[IndicatorDataPoint], System.IComparable, System.IComparable[IIndicator[IndicatorDataPoint]], QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, QuantConnect.Indicators.IIndicator[IndicatorDataPoint], QuantConnect.Indicators.IIndicator):
    """
...
class CommodityChannelIndex(QuantConnect.Indicators.BarIndicator, System.IComparable, System.IComparable[IIndicator[IBaseDataBar]], QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, QuantConnect.Indicators.IIndicator[IBaseDataBar], QuantConnect.Indicators.IIndicator):
    """
...
class CompositeIndicator(QuantConnect.Indicators.IndicatorBase[IndicatorDataPoint], System.IComparable, System.IComparable[IIndicator[IndicatorDataPoint]], QuantConnect.Indicators.IIndicator[IndicatorDataPoint], QuantConnect.Indicators.IIndicator):
    """
...
class ConstantIndicator(QuantConnect.Indicators.IndicatorBase[T], System.IComparable, System.IComparable[IIndicator[T]], QuantConnect.Indicators.IIndicator[T], QuantConnect.Indicators.IIndicator):
...
class CoppockCurve(QuantConnect.Indicators.IndicatorBase[IndicatorDataPoint], System.IComparable, System.IComparable[IIndicator[IndicatorDataPoint]], QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, QuantConnect.Indicators.IIndicator[IndicatorDataPoint], QuantConnect.Indicators.IIndicator):
    """
...
class Delay(QuantConnect.Indicators.WindowIndicator[IndicatorDataPoint], System.IComparable, System.IComparable[IIndicator[IndicatorDataPoint]], QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, QuantConnect.Indicators.IIndicator[IndicatorDataPoint], QuantConnect.Indicators.IIndicator):
    """
...
class DetrendedPriceOscillator(QuantConnect.Indicators.IndicatorBase[IndicatorDataPoint], System.IComparable, System.IComparable[IIndicator[IndicatorDataPoint]], QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, QuantConnect.Indicators.IIndicator[IndicatorDataPoint], QuantConnect.Indicators.IIndicator):
    """
...
class DonchianChannel(QuantConnect.Indicators.BarIndicator, System.IComparable, System.IComparable[IIndicator[IBaseDataBar]], QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, QuantConnect.Indicators.IIndicator[IBaseDataBar], QuantConnect.Indicators.IIndicator):
    """
...
class DoubleExponentialMovingAverage(QuantConnect.Indicators.IndicatorBase[IndicatorDataPoint], System.IComparable, System.IComparable[IIndicator[IndicatorDataPoint]], QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, QuantConnect.Indicators.IIndicator[IndicatorDataPoint], QuantConnect.Indicators.IIndicator):
    """
