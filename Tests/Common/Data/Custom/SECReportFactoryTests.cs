...
{
    [TestFixture]
    public class SecReportFactoryTests
    {
        ...
        [TestCase("<TEXT>", false)]
        public void SecReportFactory_LineHasValue(string line, bool expected)
        {
            var factory = new SECReportFactory();

            Assert.AreEqual(expected, factory.HasValue(line));
        }
        ...
        [TestCase("<TEXT>", "")]
        public void SecReportFactory_GetsTagValueFromInput(string line, string expected)
        {
            var factory = new SECReportFactory();
            
            Assert.AreEqual(expected, factory.GetTagValueFromLine(line));
        }
        ...
        [TestCase("<TEXT>", "TEXT")]
        public void SecReportFactory_ShouldReturnInternalTagName(string line, string expected)
        {
            var factory = new SECReportFactory();

            Assert.AreEqual(expected, factory.GetTagNameFromLine(line));
        }
    }
}
