...
namespace QuantConnect.Data.Custom.BrainData
{
    ...
    /// This class represents the averaged thirty day sentiment.
    /// </summary>
    public class BrainDataSentimentMonthly : BaseData
    {
        /// <summary>
        ...
        /// </summary>
        public BrainDataSentimentMonthly()
        {
        }
        ...
        public override BaseData Reader(SubscriptionDataConfig config, string line, DateTime date, bool isLiveMode)
        {
            ...
            return new BrainDataSentimentMonthly
            {
        ...
        /// <summary>
        /// Enables mapping for this data source
        /// </summary>
