        ...
        private static readonly List<CommandLineOption> Options = new List<CommandLineOption>
            {
                ...
                new CommandLineOption("source-meta-dir", CommandOptionType.SingleValue, "[REQUIRED for IVolatilityEquityConverter, PsychSignalDataConverter, SECDataConverter. For PsychSignalDataConverter and SECDataConverter, this is the path to the known equities folder (i.e. equity daily folder)]"),
