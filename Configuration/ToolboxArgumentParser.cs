        ...
        private static readonly List<CommandLineOption> Options = new List<CommandLineOption>
            {
                new CommandLineOption("app", CommandOptionType.SingleValue,
                                                     ...
                                                     + "/SECConverter or SECCV/YahooDownloader or YDL/AlgoSeekFuturesConverter or ASFC/AlgoSeekOptionsConverter or ASOC"
                ...
                new CommandLineOption("from-date", CommandOptionType.SingleValue, "[REQUIRED ALL downloaders and SECConverter] --from-date=yyyyMMdd-HH:mm:ss"),
                ...
                new CommandLineOption("source-dir", CommandOptionType.SingleValue, "[REQUIRED for IVolatilityEquityConverter, KaikoDataConverter,"
                                                                                   + " CoinApiDataConverter, NseMarketDataConverter, QuantQuoteConverter, SECDownloader, PsychSignalDataConverter]"),
                new CommandLineOption("destination-dir", CommandOptionType.SingleValue, "[REQUIRED for IVolatilityEquityConverter, "
                                                                                        + "NseMarketDataConverter, QuantQuoteConverter, SECDownloader, SECConverter, PsychSignalDataDownloader, PsychSignalDataConverter]"),
                new CommandLineOption("source-meta-dir", CommandOptionType.SingleValue, "[REQUIRED for IVolatilityEquityConverter, PsychSignalDataConverter, SECConverter. For SECConverter, this is the path to the known equities folder (i.e. equity daily folder)]"),
